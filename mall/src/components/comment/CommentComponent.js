...
const CommentComponent = ({comment, index, handleClickModify}) => {
    ...
    return (
        ...
        >
                ...
                {comment.nickname === currentMemberNickname ?
                    <div className="flex relative">
                        ...
                        >
                            ...
                            <button className="flex cursor-pointer hover:text-red-600">
                                <svg
            ...
            <div className="flex">
                <div className="text-sm text-gray-500">{comment.regTime}</div>
                {/*답글 쓰기*/}
            </div>
        </li>
    )
